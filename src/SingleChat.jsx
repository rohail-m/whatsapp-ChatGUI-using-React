...
const SingleChat = ({ image, name, message, day }) => {
  return (
    <>
      <div className="p-5 m-3 bg-white shadow rounded-md shadow-gray-300">
        <div className="flex justify-between">
          ...
          <div className="right">
            <h6 className="day text-green-500 capitalize">{day}</h6>
